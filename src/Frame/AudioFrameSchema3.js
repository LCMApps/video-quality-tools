...
/**
 * @typedef {Object} RawAudioFrameSchema3DataExtraFields
 *
...
/**
 * @typedef {RawAudioFrameDataImported & RawAudioFrameSchema3DataExtraFields} RawAudioFrameSchema3Data
 */

/**
 * AudioFrameSchema1 describes the "schema 3" layout for audio frame objects.
 ...
 */
class AudioFrameSchema3 extends BaseAudioFrame {
    static get schema() {
        return 3;
    }

    /**
     * @param {RawAudioFrameSchema3Data} frameData Raw frame object (e.g., from ffprobe).
     */
...
module.exports = AudioFrameSchema3;
