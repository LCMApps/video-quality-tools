...
/**
 * Raw video frame data for schema 4 (ffprobe output mapped as-is).
 * All properties are optional.
 *
 * @typedef {Object} RawVideoFrameSchema4DataExtraFields
 *
...
/**
 * @typedef {RawVideoFrameDataImported & RawVideoFrameSchema4DataExtraFields} RawVideoFrameSchema4Data
 */

/**
 * VideoFrameSchema2 describes the "schema 4" layout for video frame objects.
 ...
 */
class VideoFrameSchema4 extends BaseVideoFrame {
    static get schema() {
        return 4;
    }

    /**
     * @param {RawVideoFrameSchema4Data} frameData Raw frame object (e.g., from ffprobe).
     */
...
module.exports = VideoFrameSchema4;
