...
/**
 * Raw video frame data for schema 2 (ffprobe output mapped as-is).
 * All properties are optional.
 *
 * @typedef {Object} RawVideoFrameSchema2DataExtraFields
 *
...
/**
 * @typedef {RawVideoFrameDataImported & RawVideoFrameSchema2DataExtraFields} RawVideoFrameSchema2Data
 */

/**
 * VideoFrameSchema2 describes the "schema 2" layout for video frame objects.
 ...
 */
class VideoFrameSchema2 extends BaseVideoFrame {
    static get schema() {
        return 2;
    }

    /**
     * @param {RawVideoFrameSchema2Data} frameData Raw frame object (e.g., from ffprobe).
     */
...
module.exports = VideoFrameSchema2;
