...
describe('FramesReducer::reset', () => {
    ...
    it("must emit an error on the second process call, the cache buffer is exhausted and reset wasn't called", () => {
    ...
    it('must not emit an error on the second process call, the reset method was called', () => {
        const spy = sinon.spy();
