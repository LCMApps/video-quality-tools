...
describe('processFrames.encoderStats - raw frame object', () => {
...
describe('processFrames.encoderStats - frame value objects', () => {
    ...
    it('must throw an exception cuz method cannot find gop', () => {
        const frames = [
            ...
            new AudioFrameSchema1({pkt_size: 2, pkt_pts_time: 2, media_type: 'audio', key_frame: 1}),
            new VideoFrameSchema1({pkt_size: 5, pkt_pts_time: 17, media_type: 'video', key_frame: 0}),
            new VideoFrameSchema1({pkt_size: 7, pkt_pts_time: 19, media_type: 'video', key_frame: 0}),
            new AudioFrameSchema1({pkt_size: 4, pkt_pts_time: 4, media_type: 'audio', key_frame: 1}),
        ];
    ...
    it('must return correct info just fine', () => {
        const frames1 = [
            new VideoFrameSchema1({width: 640, height: 480, pkt_size: 1, pkt_pts_time: 11, media_type: 'video', key_frame: 1}),
            new VideoFrameSchema1({width: 640, height: 480, pkt_size: 3, pkt_pts_time: 13, media_type: 'video', key_frame: 0}),
            new VideoFrameSchema1({width: 640, height: 480, pkt_size: 5, pkt_pts_time: 15, media_type: 'video', key_frame: 1}),
            new VideoFrameSchema1({width: 640, height: 480, pkt_size: 7, pkt_pts_time: 17, media_type: 'video', key_frame: 0}),
            new VideoFrameSchema1({width: 640, height: 480, pkt_size: 9, pkt_pts_time: 19, media_type: 'video', key_frame: 1})
        ];

        const frames2 = [
            new AudioFrameSchema1({width: 854, height: 480, pkt_size: 1, pkt_pts_time: 1, media_type: 'audio', key_frame: 1}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 1, pkt_pts_time: 11, media_type: 'video', key_frame: 0}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 2, pkt_pts_time: 13, media_type: 'video', key_frame: 0}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 3, pkt_pts_time: 15, media_type: 'video', key_frame: 1}),
            new AudioFrameSchema1({width: 854, height: 480, pkt_size: 3, pkt_pts_time: 15, media_type: 'audio', key_frame: 1}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 4, pkt_pts_time: 17, media_type: 'video', key_frame: 0}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 5, pkt_pts_time: 19, media_type: 'video', key_frame: 0}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 6, pkt_pts_time: 21, media_type: 'video', key_frame: 1}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 7, pkt_pts_time: 23, media_type: 'video', key_frame: 0}),
            new AudioFrameSchema1({width: 854, height: 480, pkt_size: 3, pkt_pts_time: 15, media_type: 'audio', key_frame: 1}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 8, pkt_pts_time: 25, media_type: 'video', key_frame: 0}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 9, pkt_pts_time: 27, media_type: 'video', key_frame: 1}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 10, pkt_pts_time: 29, media_type: 'video', key_frame: 0})
        ];
        ...
        const expectedRemainedFrames1 = [
            new VideoFrameSchema1({pkt_size: 9, pkt_pts_time: 19, media_type: 'video', key_frame: 1, width: 640, height: 480})
        ];
        ...
        const expectedRemainedFrames2 = [
            new VideoFrameSchema1({pkt_size: 9, pkt_pts_time: 27, media_type: 'video', key_frame: 1, width: 854, height: 480}),
            new VideoFrameSchema1({pkt_size: 10, pkt_pts_time: 29, media_type: 'video', key_frame: 0, width: 854, height: 480})
        ];
    ...
    it('must detect that GOPs is not identical ', () => {
        const frames = [
            ...
            new VideoFrameSchema1({width: 640, height: 480, pkt_size: 3, pkt_pts_time: 13, media_type: 'video', key_frame: 0}),
            new VideoFrameSchema1({width: 640, height: 480, pkt_size: 5, pkt_pts_time: 15, media_type: 'video', key_frame: 1}),
            new VideoFrameSchema1({width: 640, height: 480, pkt_size: 6, pkt_pts_time: 17, media_type: 'video', key_frame: 0}),
            new VideoFrameSchema1({width: 640, height: 480, pkt_size: 9, pkt_pts_time: 19, media_type: 'video', key_frame: 0}),
            new VideoFrameSchema1({width: 640, height: 480, pkt_size: 11, pkt_pts_time: 21, media_type: 'video', key_frame: 1})
        ];
        ...
        const expectedRemainedFrames = [
            new VideoFrameSchema1({pkt_size: 11, pkt_pts_time: 21, media_type: 'video', key_frame: 1, width: 640, height: 480})
        ];
