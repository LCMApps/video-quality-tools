...
const {invalidFramesTypes, invalidDurationInSecTypes, testData, testDataWithValueObjects} = require('./networkStats.data');
...
describe('processFrames.networkStats - raw frame object', () => {
...
describe('processFrames.networkStats - frame value objects', () => {
    ...
    dataDriven(testDataWithValueObjects, () => {
        it('{description}', ctx => {
            const expectedResult = ctx.expected;
