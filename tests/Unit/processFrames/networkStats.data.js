...
const testDataWithValueObjects = [
    {
        description: 'empty frames array',
        frames        : [],
        durationInMsec: 1000,
    ...
    },
    {
        description   : 'audio only frames with 1000 msec duration',
        frames        : [
            new AudioFrameSchema1({pkt_size: 2, pkt_pts_time: 10, media_type: 'audio', key_frame: 1}),
            new AudioFrameSchema1({pkt_size: 3, pkt_pts_time: 11, media_type: 'audio', key_frame: 1}),
        ],
        durationInMsec: 1000,
        expected      : {
            videoFrameRate: 0,
    ...
    },
    {
        description   : 'video only frames with 1000 msec duration',
        frames        : [
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 2, pkt_pts_time: 1, media_type: 'video', key_frame: 1, pict_type: 'P'}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 3, pkt_pts_time: 10, media_type: 'video', key_frame: 0, pict_type: 'P'}),
        ],
        durationInMsec: 1000,
        expected      : {
            videoFrameRate: 2,
    ...
    },
    {
        ...
        frames        : [
            ...
            new AudioFrameSchema1({pkt_size: 3, pkt_pts_time: 11, media_type: 'audio', key_frame: 1}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 3, pkt_pts_time: 10, media_type: 'video', key_frame: 0, pict_type: 'P'}),
            new AudioFrameSchema1({pkt_size: 4, pkt_pts_time: 12, media_type: 'audio', key_frame: 1}),
        ],
        durationInMsec: 200,
        expected      : {
            videoFrameRate: 10,
    ...
    },
    {
        description   : 'audio only frames with 2000 msec duration',
        frames        : [
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 5, pkt_pts_time: 1, media_type: 'video', key_frame: 1, pict_type: 'P'}),
            new AudioFrameSchema1({pkt_size: 2, pkt_pts_time: 10, media_type: 'audio', key_frame: 1}),
            new AudioFrameSchema1({pkt_size: 3, pkt_pts_time: 11, media_type: 'audio', key_frame: 1}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 6, pkt_pts_time: 10, media_type: 'video', key_frame: 0, pict_type: 'P'}),
            new AudioFrameSchema1({pkt_size: 4, pkt_pts_time: 12, media_type: 'audio', key_frame: 1}),
            new VideoFrameSchema1({width: 854, height: 480, pkt_size: 7, pkt_pts_time: 10, media_type: 'video', key_frame: 0, pict_type: 'I'}),
        ],
        durationInMsec: 2000,
        expected      : {
            videoFrameRate: 1.5,
